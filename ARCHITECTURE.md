# ðŸ›ï¸ Architecture Specification: PR-Architect-Play
...
2. **Zero-Token Replayability**:
   Once registered, the execution parameters (owner, epo, pull_number) are bound to structured pipeline inputs. The model acts as a compiler pass rather than an unbounded agent.
...
[AST Tokenizer & Chunking]
      â”‚
      â”œâ”€â”€> [Stage 1: Breaking Change Detector] (Catches unmerged commits, lint bypasses)
      â”‚
      â””â”€â”€> [Stage 2: Architecture Boundary Mapper] (Catches core vs wrapper divergence)
      â”‚
      â–¼
